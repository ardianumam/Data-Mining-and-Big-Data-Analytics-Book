...
labelTraining = to_categorical(labelTraining, num_classes=2)
...
#train NN
model.fit(inputTraining, labelTraining, epochs=400, batch_size=5)

#memprediksi data testing dengan model NN yg sdh ditraining
hasilPrediksi = model.predict_classes(inputTesting, batch_size=1)
