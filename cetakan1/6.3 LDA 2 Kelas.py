...
#hitung matrik kovarians kelas 1 (Haltica oleracea) dan kelas 2 (Haltica carduorum)
...
S = ((Xole.shape[0] - 1) * Sole + (Xcar.shape[0] - 1) * Scar) / ((Xole.shape[0] - 1) + (Xcar.shape[0] - 1))
print("S: ", S)
...
XcarLDA_prediksi[XcarLDA<=thresh]=2#jika krg dari atw sama, masuk ke kelas 2
